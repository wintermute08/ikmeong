  ...
  return (
    <div className="page-enter">
      <div className="px-5 pt-5 pb-4 flex items-center gap-3">
        ...
        <h1 className="text-[18px] font-black text-ink flex-1">글 쓰기</h1>
        <button
      ...
      <form onSubmit={handleSubmit} className="px-5 flex flex-col gap-4">
        ...
        <div>
          <input
            ...
            maxLength={100}
          />
          <p className="text-ink3 text-[12px] mt-1.5 text-right">{title.length}/100</p>
        </div>
        ...
        <div>
          <textarea
            ...
            maxLength={5000}
          />
          <p className="text-ink3 text-[12px] mt-1.5 text-right">{content.length}/5000</p>
        </div>
