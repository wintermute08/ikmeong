    ...
    <Link href={`/post/${post.id}`}>
      <div className="post-row">
        <div className="flex items-start gap-2">
          ...
          <p className="text-[15px] font-semibold text-ink leading-snug flex-1 line-clamp-2">{post.title}</p>
        </div>
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          <span className="text-ink3 text-[12px]">{formatTimeAgo(post.created_at)}</span>
